...
function add_5_tier_stuff (loot_table as string, min_value as int, max_value as int) {
	...
	pool.addItemEntry(<metallurgy:midasium_ingot>, 2);
	pool.addItemEntry(<metallurgy:krik_ingot>, 2);
	pool.addItemEntry(<metallurgy:rubracium_ingot>, 2);
	pool.addItemEntry(<metallurgy:tartarite_ingot>, 2);
	pool.addItemEntry(<metallurgy:atlarus_ingot>, 2);
	pool.addItemEntry(<metallurgy:vyroxeres_ingot>, 2);
	pool.addItemEntry(<metallurgy:inolashite_ingot>, 2);
	pool.addItemEntry(<metallurgy:meutoite_ingot>, 2);
	pool.addItemEntry(<metallurgy:ceruclase_ingot>, 2);
	pool.addItemEntry(<metallurgy:kalendrite_ingot>, 2);
	pool.addItemEntry(<metallurgy:eximite_ingot>, 2);
	pool.addItemEntry(<metallurgy:sanguinite_ingot>, 2);
	pool.addItemEntry(<metallurgy:desichalkos_ingot>, 2);
	pool.addItemEntry(<metallurgy:mithril_ingot>, 2);
	pool.addItemEntry(<metallurgy:quicksilver_ingot>, 2);
	pool.addItemEntry(<metallurgy:etherium_ingot>, 2);
	pool.addItemEntry(<metallurgy:vulcanite_ingot>, 2);
	pool.addItemEntry(<metallurgy:alduorite_ingot>, 2);
	pool.addItemEntry(<metallurgy:haderoth_ingot>, 2);
	pool.addItemEntry(<metallurgy:amordrine_ingot>, 2);
