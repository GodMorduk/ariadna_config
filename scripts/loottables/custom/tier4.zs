...
function add_4_tier_stuff (loot_table as string, min_value as int, max_value as int) {
	...
	pool.addItemEntry(<metallurgy:orichalcum_ingot>, 2);
	pool.addItemEntry(<metallurgy:shadow_steel_ingot>, 2);
	pool.addItemEntry(<metallurgy:black_steel_ingot>, 2);
	pool.addItemEntry(<metallurgy:adamantine_ingot>, 2);
	pool.addItemEntry(<metallurgy:lutetium_ingot>, 2);
	pool.addItemEntry(<metallurgy:carmot_ingot>, 2);
	pool.addItemEntry(<metallurgy:celenegil_ingot>, 2);
	pool.addItemEntry(<metallurgy:shadow_iron_ingot>, 2);
