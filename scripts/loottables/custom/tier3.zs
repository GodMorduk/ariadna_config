...
function add_3_tier_stuff (loot_table as string, min_value as int, max_value as int) {
	...
	pool.addItemEntry(<flansmod:dwflamelupine>, 15);
	pool.addItemEntry(<stewitems:medicine_blood>, 20);
	pool.addItemEntry(<stewitems:medicine_inhaler>, 20);
	pool.addItemEntry(<stewitems:medicine_nanits>, 20);
	pool.addItemEntry(<stewitems:medicine_valkyrine>, 20);
	pool.addItemEntry(<stewitems:medicine_nictogenic>, 20);
	pool.addItemEntry(<stewitems:medicine_antidote>, 20);
	pool.addItemEntry(<stewitems:medicine_phenophasine>, 20);
	pool.addItemEntry(<stewitems:medicine_corpideks>, 20);
	pool.addItemEntry(<stewitems:medicine_nicotine_gum>, 20);
	pool.addItemEntry(<stewitems:medicine_yoln_tear>, 20);
	pool.addItemEntry(<stewitems:medicine_tranquilizer>, 20);
	pool.addItemEntry(<stewitems:medicine_painkillers>, 20);
	pool.addItemEntry(<stewitems:medicine_medx>, 20);
	pool.addItemEntry(<stewitems:medicine_nanite_injection>, 20);
	...
	pool.addItemEntry(<stewitems:medicine_ironskin_pills>, 20);
	pool.addItemEntry(<stewitems:medicine_heating_paste>, 20);
