...
RecipeBuilder.get("blacksmith")
  .setShaped([
    ...
    [<enderio:block_alloy:2>, <ore:blockValonite>, <metallurgy:atlarus_block>, null, null],
    [<metallurgy:atlarus_block>, <metallurgy:atlarus_block>, <ore:blockValonite>, null, null],
