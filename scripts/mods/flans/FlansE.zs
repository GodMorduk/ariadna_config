...
recipes.addShaped(<flansmod:dwshockskymare>,[
    ...
    [<minecraft:iron_ingot>, <immersiveengineering:toolupgrade:6>, <minecraft:iron_ingot>],
    [null, <minecraft:iron_ingot>, null]]);
  
recipes.addShaped(<flansmod:dwflashambircon>,[
    [null, <minecraft:iron_ingot>, <minecraft:flint_and_steel>],
    [<enderio:block_fused_quartz>, <minecraft:glowstone>, <enderio:block_fused_quartz>],
    [null, <minecraft:iron_ingot>, null]]);
...
recipes.addShaped(<flansmod:dwlupineremote>.withTag({Rot: {start: 151200000 as long, time: 12096000 as long}}),[
    ...
    [<industrialforegoing:plastic>, <techguns:itemshared:65>, <industrialforegoing:plastic>],
    [<industrialforegoing:plastic>, <minecraft:iron_ingot>, <industrialforegoing:plastic>]]);