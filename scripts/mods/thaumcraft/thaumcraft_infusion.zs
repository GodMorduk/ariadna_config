...
mods.thaumcraft.Infusion.registerRecipe("thaumcraft:voidseerpearl", "VOIDSEERPEARL", <thaumcraft:voidseer_charm>, 85, [<aspect:cognitio>*1000, <aspect:vacuos>*1000, <aspect:praecantatio>*1000, <aspect:alienis>*1000], <thaumcraft:baubles:4>, [<thaumicaugmentation:material:3>, <thaumcraft:void_seed>, <thaumcraft:void_seed>, <thaumcraft:void_seed>, <thaumcraft:void_seed>, <thaumcraft:void_seed>]);
