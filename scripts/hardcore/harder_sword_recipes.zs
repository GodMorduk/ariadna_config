...
//recipes.addShaped("equipment/knightmetal_sword", <twilightforest:knightmetal_sword>, [[null, <ore:blockKnightmetal>, null],[<ore:blockKnightmetal>, <ore:blockKnightmetal>, <ore:blockKnightmetal>],[null, <ore:stickWood>, null] ]);

recipes.removeByRecipeName("twilightforest:equipment/ironwood_sword");
//recipes.addShaped("equipment/ironwood_sword", <twilightforest:ironwood_sword>, [[null, <twilightforest:block_storage>, null],[<twilightforest:block_storage>, <twilightforest:block_storage>, <twilightforest:block_storage>],[null, <ore:stickWood>, null] ]);

recipes.removeByRecipeName("twilightforest:equipment/fiery_sword");
//recipes.addShaped("equipment/fiery_sword", <twilightforest:fiery_sword>, [[null, <ore:blockFiery>, null],[<ore:blockFiery>, <ore:blockFiery>, <ore:blockFiery>],[null, <ore:stickWood>, null] ]);

recipes.removeByRecipeName("twilightforest:equipment/steeleaf_sword");
//recipes.addShaped("equipment/steeleaf_sword", <twilightforest:steeleaf_sword>, [[null, <ore:blockSteeleaf>, null],[<ore:blockSteeleaf>, <ore:blockSteeleaf>, <ore:blockSteeleaf>],[null, <ore:stickWood>, null] ]);
